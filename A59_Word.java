...
//the letters' register in every word so that it either only consisted of lowercase letters or, vice
//versa, only of uppercase ones. At that as little as possible letters should be changed in the
//word. For example, the word HoUse must be replaced with house, and the word ViP-
//with VIP. If a word contains an equal number of uppercase and lowercase letters, you should
