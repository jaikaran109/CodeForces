...
//
//Then n lines follow, each contains two integers di and bi (0 <ai, bi≤1000)-the number of
//passengers that exits the tram at the i-th stop, and the number of passengers that enter the
//tram at the i-th stop. The stops are given from the first to the last stop in the order of tram's
//movement.
//
//. The number of people who exit at a given stop does not exceed the total number of
//people in the tram immediately before it arrives at the stop. More formally,
//Vi (1≤i ≤n) : Ejibi -Ej1aj aj. This particularly means that a1= 0.
