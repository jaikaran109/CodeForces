...
//
//Output
//If Anton won more games than Danik, print "Anton" (without quotes) in the only line of the
//output.
//
//If Danik won more games than Anton, print "Danik" (without quotes) in the only line of the
//output.
//
