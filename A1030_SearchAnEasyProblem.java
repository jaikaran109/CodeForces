...
//about their opinions. Each person answered whether this problem is easy or hard.
//
//If at least one of these n people has answered that the problem is hard, the coordinator
//decides to change the problem. For the given responses, check if the problem is easy
//enough.
//
//Input
//The first line contains a single integer n (1 < n < 100)- the number of people who were
...
//person thinks that the problem is easy; if it is 1, then i-th person thinks that the problem is
//hard.
//
//Output
...
import java.util.*;
public class A1030_SearchAnEasyProblem {
